...
===                              MultiTestCycleExample done 1,000,000 time(s) in   2.7 sec (  2.7 mks/try) ===
                                ...
                                ------------------ ------- ------------
```
It is quite clear now why simple code running in 3 parallel threads must be synchronized. Frankly speacking I've expected result like this `a,b,c={1,2,X}` where `X=0,1,2`. But how come `a,b,c={1,1,X}||{2,2,X}`? Any ideas? :)
